export const roomsMessages = {
  ...
  'rooms.create.allowBots': 'Возможность добавить ботов',
  ...
  'lobby.bot.easy': 'Бот · лёгкий',
  'lobby.bot.hard': 'Бот · сложный',
  'lobby.bot.label': 'Бот',
  'lobby.bot.add': 'Добавить лёгкого бота',
  'lobby.bot.adding': 'Добавляем...',
  'lobby.bot.remove': 'Убрать',
  'lobby.bot.removing': 'Убираем...',
  ...
  'matches.player.bot.easy': 'Бот · лёгкий',
  'matches.player.bot.hard': 'Бот · сложный',
