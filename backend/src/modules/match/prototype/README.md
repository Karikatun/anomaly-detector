...
Question: does the proposed round state machine make Access Slot conflicts, reverse Power planning, and phase-by-phase Action order deterministic and understandable for 2-4 players?
...
- every player requesting the same Access Slot;
- a player displaced from a contested slot into an already requested later slot;
- a late Access Slot planning first but acting later;
- players with no Power in a phase being skipped.
