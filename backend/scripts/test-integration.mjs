...
run('bun', ['test', 'src/modules/admin/admin.integration.test.ts', 'src/modules/auth/auth.integration.test.ts', 'src/modules/mail/infrastructure/prisma-mail-policy-repository.integration.test.ts', 'src/modules/mail/infrastructure/prisma-transactional-mail-outbox.integration.test.ts', 'src/modules/profile/profile.integration.test.ts', 'src/modules/room/infrastructure/room-repository.contract.integration.test.ts', 'src/modules/room/room-start.integration.test.ts', 'src/modules/tender/tender.integration.test.ts', 'src/modules/tender/realtime/realtime.integration.test.ts'], { env })
