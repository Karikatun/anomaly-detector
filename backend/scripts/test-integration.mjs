...
run('bun', ['test', 'src/modules/auth/auth.integration.test.ts', 'src/modules/room/room-start.integration.test.ts', 'src/modules/tender/tender.integration.test.ts', 'src/modules/tender/realtime/realtime.integration.test.ts'], { env })
