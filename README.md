...
`Anomaly Detector` — синхронная соревновательная браузерная игра на дедукцию. Можно играть с друзьями или в одиночку против ботов; в партии участвуют 2–4 исследователя, включая ботов.

Обучение доступно без регистрации. После него можно создать аккаунт или войти,
сохранить отметку о прохождении и перейти к первой партии.
